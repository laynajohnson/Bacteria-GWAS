...
![MIC example. *Modified by Alayna Jonhson](figures/MIC.png)
...
![Phylogeny tree with binarized MIC to show suceptibility or resistance to Azithromycin](figures/phylogeny_tree.png)
...
![Linear model before GWAS](figures/LINEAR_bef_GWAS.png)
...
![mtrC variant resulted on mtrC LOF (Loss of function). *Modified by Alayna Jonhson](figures/Efflux_pump_LOF.png)
...
![Linear model after GWAS](figures/LINEAR_af_GWAS.png)
