...
![MIC example.](figures/MIC.png){width=50%}
...
![Phylogenetic tree with binarized MIC to show suceptibility or resistance to Azithromycin.](figures/phylogeny_tree.png){width=50%}
...
![Linear model before GWAS](figures/LINEAR_bef_GWAS.png){width=50%}
...
![mtrC variant resulted on mtrC LOF (Loss of function).](figures/Efflux_pump_LOF.png){width=50%}
...
![Linear model after GWAS](figures/LINEAR_af_GWAS.png){width=50%}
